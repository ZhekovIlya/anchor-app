const week1Lessons = [
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Вы хороший",uk:"Ви добрий",es:"Usted es bueno",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"es",type:"verb"},{text:" ",type:"space"},{text:"bueno",type:"object"}],meta:{id:"ser_pres_usted_aff_bueno",lemma:"ser",person:"usted",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Они (мужской род) не глупые",uk:"Вони (ч.р.) не дурні",es:"Ellos no son tontos",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"tontos",type:"object"}],meta:{id:"ser_pres_ellos_neg_tontos",lemma:"ser",person:"ellos",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Они (женский род) не плохие",uk:"Вони (ж.р.) не погані",es:"Ellas no son malas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"malas",type:"object"}],meta:{id:"ser_pres_ellas_neg_malas",lemma:"ser",person:"ellas",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Вы здесь",uk:"Ви тут",es:"Usted está aquí",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_usted_aff_aqui",lemma:"estar",person:"usted",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}}
    ]
  },
  {
    ...
    phrases: [
      ...
      {ru:"Она не здесь",uk:"Вона не тут",es:"Ella no está aquí",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"aquі",type:"object"}],meta:{id:"estar_pres_ella_neg_aqui",lemma:"estar",person:"ella",polarity:"negative",tense:"present",tags:["location"],confusable_with:"ser"}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Они (мужской род) не здесь",uk:"Вони (ч.р.) не тут",es:"Ellos no están aquí",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_ellos_neg_aqui",lemma:"estar",person:"ellos",polarity:"negative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Они (женский род) готовы",uk:"Вони (ж.р.) готові",es:"Ellas están listas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"listas",type:"object"}],meta:{id:"estar_pres_ellas_aff_listas",lemma:"estar",person:"ellas",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
