const week1Lessons = [
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Ты не (есть)",uk:"Ти не (є)",es:"Tú no eres",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"eres",type:"verb"}],meta:{id:"ser_pres_tu_neg",lemma:"ser",person:"tu",polarity:"negative",tense:"present",tags:["identity"],confusable_with:"estar"}},
      ...
      {ru:"Ты не находишься",uk:"Ти не знаходишся",es:"Tú no estás",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"estás",type:"verb"}],meta:{id:"estar_pres_tu_neg",lemma:"estar",person:"tu",polarity:"negative",tense:"present",tags:["state","location"],confusable_with:"ser"}},
      ...
      {ru:"Ты не идешь",uk:"Ти не йдеш",es:"Tú no vas",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"vas",type:"verb"}],meta:{id:"ir_pres_tu_neg",lemma:"ir",person:"tu",polarity:"negative",tense:"present",tags:["motion"],confusable_with:null}}
    ]
  },
  {
    id: "w1_l2b", 
    ...
    phrases: [
      ...
      {ru:"Она находилась",uk:"Вона знаходиться",es:"Ella está",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"}],meta:{id:"estar_pres_ella_aff",lemma:"estar",person:"ella",polarity:"affirmative",tense:"present",tags:["state","location"],confusable_with:"ser"}},
      {ru:"Вы идет (вежливо)",uk:"Ви йдете (ввічливо)",es:"Usted va",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"va",type:"verb"}],meta:{id:"ir_pres_usted_aff",lemma:"ir",person:"usted",polarity:"affirmative",tense:"present",tags:["motion"],confusable_with:null}},
      {ru:"Он не находится",uk:"Він не знаходиться",es:"Él no está",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"está",type:"verb"}],meta:{id:"estar_pres_el_neg",lemma:"estar",person:"el",polarity:"negative",tense:"present",tags:["state","location"],confusable_with:"ser"}},
      {ru:"Она не идет",uk:"Вона не йду",es:"Ella no va",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"va",type:"verb"}],meta:{id:"ir_pres_ella_neg",lemma:"ir",person:"ella",polarity:"negative",tense:"present",tags:["motion"],confusable_with:null}},
      {ru:"Вы не (есть) (вежливо)",uk:"Ви не (є) (ввічливо)",es:"Usted no es",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"es",type:"verb"}],meta:{id:"ser_pres_usted_neg",lemma:"ser",person:"usted",polarity:"negative",tense:"present",tags:["identity"],confusable_with:"estar"}}
    ]
  },
  {
    id: "w1_l3", 
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Они (женский род) находятся",uk:"Вони (жіночий рід) знаходяться",es:"Ellas están",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"}],meta:{id:"estar_pres_ellas_aff",lemma:"estar",person:"ellas",polarity:"affirmative",tense:"present",tags:["state","location"],confusable_with:"ser"}},
      {ru:"Вы идите (вежливо)",uk:"Ви йдете (ввічливо)",es:"Ustedes van",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"van",type:"verb"}],meta:{id:"ir_pres_ustedes_aff",lemma:"ir",person:"ustedes",polarity:"affirmative",tense:"present",tags:["motion"],confusable_with:null}},
      {ru:"Они (мужской род) не (есть)",uk:"Вони (ч.р.) не (є)",es:"Ellos no son",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"son",type:"verb"}],meta:{id:"ser_pres_ellos_neg",lemma:"ser",person:"ellos",polarity:"negative",tense:"present",tags:["identity"],confusable_with:"estar"}},
      {ru:"Они (женский род) не находятся",uk:"Вони (ж.р.) не знаходяться",es:"Ellas no están",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"están",type:"verb"}],meta:{id:"estar_pres_ellas_neg",lemma:"estar",person:"ellas",polarity:"negative",tense:"present",tags:["state","location"],confusable_with:"ser"}},
      {ru:"Вы не идете (вежливо)",uk:"Ви не йдете (ввічливо)",es:"Ustedes no van",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"van",type:"verb"}],meta:{id:"ir_pres_ustedes_neg",lemma:"ir",person:"ustedes",polarity:"negative",tense:"present",tags:["motion"],confusable_with:null}}
    ]
  },
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"У тебя нет",uk:"Ти не маєш",es:"Tú no tienes",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"tienes",type:"verb"}],meta:{id:"tener_pres_tu_neg",lemma:"tener",person:"tu",polarity:"negative",tense:"present",tags:["possession"],confusable_with:null}},
      ...
      {ru:"Ты не делаешь",uk:"Ти не робиш",es:"Tú no haces",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"haces",type:"verb"}],meta:{id:"hacer_pres_tu_neg",lemma:"hacer",person:"tu",polarity:"negative",tense:"present",tags:["action"],confusable_with:null}},
      ...
      {ru:"Ты не говоришь",uk:"Ти не кажеш",es:"Tú no dices",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"dices",type:"verb"}],meta:{id:"decir_pres_tu_neg",lemma:"decir",person:"tu",polarity:"negative",tense:"present",tags:["speech"],confusable_with:null}}
    ]
  },
  {
    id: "w1_l5b", 
    ...
    phrases: [
      ...
      {ru:"У нее есть",uk:"У неї є",es:"Ella tiene",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"}],meta:{id:"tener_pres_ella_aff",lemma:"tener",person:"ella",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У вас есть (вежливо)",uk:"Ви маєте (ввічливо)",es:"Usted tiene",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"}],meta:{id:"tener_pres_usted_aff",lemma:"tener",person:"usted",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"Он не делает",uk:"Він не робить",es:"Él no hace",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"hace",type:"verb"}],meta:{id:"hacer_pres_el_neg",lemma:"hacer",person:"el",polarity:"negative",tense:"present",tags:["action"],confusable_with:null}},
      {ru:"Она не говорит",uk:"Вона не каже",es:"Ella no dice",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"dice",type:"verb"}],meta:{id:"decir_pres_ella_neg",lemma:"decir",person:"ella",polarity:"negative",tense:"present",tags:["speech"],confusable_with:null}},
      {ru:"Вы не делаете",uk:"Ви не робите",es:"Usted no hace",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"hace",type:"verb"}],meta:{id:"hacer_pres_usted_neg",lemma:"hacer",person:"usted",polarity:"negative",tense:"present",tags:["action"],confusable_with:null}}
    ]
  },
  {
    id: "w1_l6", 
  ...
  },
  {
    ...
    title: "Core Actions",
    phrases: [
      {ru:"Они (мужской род) имеют",uk:"Вони (чоловічий рід) мають",es:"Ellos tienen",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"}],meta:{id:"tener_pres_ellos_aff",lemma:"tener",person:"ellos",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"Они (женский род) делают",uk:"Вони (жіночий рід) роблять",es:"Ellas hacen",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"hacen",type:"verb"}],meta:{id:"hacer_pres_ellas_aff",lemma:"hacer",person:"ellas",polarity:"affirmative",tense:"present",tags:["action"],confusable_with:null}},
      {ru:"Вы говорите (вежливо)",uk:"Ви кажете (ввічливо)",es:"Ustedes dicen",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"dicen",type:"verb"}],meta:{id:"decir_pres_ustedes_aff",lemma:"decir",person:"ustedes",polarity:"affirmative",tense:"present",tags:["speech"],confusable_with:null}},
      {ru:"Они (мужской род) не делают",uk:"Вони (ч.р.) не роблять",es:"Ellos no hacen",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"hacen",type:"verb"}],meta:{id:"hacer_pres_ellos_neg",lemma:"hacer",person:"ellos",polarity:"negative",tense:"present",tags:["action"],confusable_with:null}},
      {ru:"Они (женский род) не имеют",uk:"Вони (ж.р.) не мають",es:"Ellas no tienen",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"tienen",type:"verb"}],meta:{id:"tener_pres_ellas_neg",lemma:"tener",person:"ellas",polarity:"negative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"Вы не говорите (вежливо)",uk:"Ви не кажете (ввічливо)",es:"Ustedes no dicen",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"dicen",type:"verb"}],meta:{id:"decir_pres_ustedes_neg",lemma:"decir",person:"ustedes",polarity:"negative",tense:"present",tags:["speech"],confusable_with:null}}
    ]
  },
  ...
  // --- Ser Sentences ---
  {
    ...
    phrases: [
      {ru:"Я хороший",uk:"Я добрий",es:"Yo soy bueno",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"soy",type:"verb"},{text:" ",type:"space"},{text:"bueno",type:"object"}],meta:{id:"ser_pres_yo_aff_bueno",lemma:"ser",person:"yo",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
  ...
  },
  {
    ...
    title: "Identity Sentences",
    phrases: [
      {ru:"Ты хороший",uk:"Ти добрий",es:"Tú eres bueno",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"eres",type:"verb"},{text:" ",type:"space"},{text:"bueno",type:"object"}],meta:{id:"ser_pres_tu_aff_bueno",lemma:"ser",person:"tu",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Ты не хороший",uk:"Ти не добрий",es:"Tú no eres bueno",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"eres",type:"verb"},{text:" ",type:"space"},{text:"bueno",type:"object"}],meta:{id:"ser_pres_tu_neg_bueno",lemma:"ser",person:"tu",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      ...
      {ru:"Ты не умный",uk:"Ти не розумний",es:"Tú no eres inteligente",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"eres",type:"verb"},{text:" ",type:"space"},{text:"inteligente",type:"object"}],meta:{id:"ser_pres_tu_neg_inteligente",lemma:"ser",person:"tu",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Ты большой",uk:"Ти великий",es:"Tú eres grande",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"eres",type:"verb"},{text:" ",type:"space"},{text:"grande",type:"object"}],meta:{id:"ser_pres_tu_aff_grande",lemma:"ser",person:"tu",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}}
    ]
  },
  {
    id: "w1_l8b", 
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Мы не маленькие",uk:"Ми не малі",es:"Nosotros no somos pequeños",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"somos",type:"verb"},{text:" ",type:"space"},{text:"pequeños",type:"object"}],meta:{id:"ser_pres_nos_neg_pequenos",lemma:"ser",person:"nosotros",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
  ...
  },
  {
    ...
    title: "Identity Sentences",
    phrases: [
      {ru:"Они (м.р.) хорошие",uk:"Вони (ч.р.) хороші",es:"Ellos son buenos",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"buenos",type:"object"}],meta:{id:"ser_pres_ellos_aff_buenos",lemma:"ser",person:"ellos",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Они (ж.р.) маленькие",uk:"Вони (ж.р.) малі",es:"Ellas son pequeñas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"pequeñas",type:"object"}],meta:{id:"ser_pres_ellas_aff_pequenas",lemma:"ser",person:"ellas",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Вы умны (вежливо)",uk:"Ви розумні (ввічливо)",es:"Ustedes son inteligentes",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"inteligentes",type:"object"}],meta:{id:"ser_pres_ustedes_aff_inteligentes",lemma:"ser",person:"ustedes",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Они (м.р.) не глупые",uk:"Вони (ч.р.) не дурні",es:"Ellos no son tontos",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"tontos",type:"object"}],meta:{id:"ser_pres_ellos_neg_tontos",lemma:"ser",person:"ellos",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Они (ж.р.) не плохие",uk:"Вони (ж.р.) не погані",es:"Ellas no son malas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"malas",type:"object"}],meta:{id:"ser_pres_ellas_neg_malas",lemma:"ser",person:"ellas",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Вы не большие",uk:"Ви не великі",es:"Ustedes no son grandes",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"grandes",type:"object"}],meta:{id:"ser_pres_ustedes_neg_grandes",lemma:"ser",person:"ustedes",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}}
    ]
  },
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Тебе не хорошо",uk:"Тобі не добре",es:"Tú no estás bien",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"estás",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_tu_neg_bien",lemma:"estar",person:"tu",polarity:"negative",tense:"present",tags:["state"],confusable_with:"ser"}},
      ...
      {ru:"Ты не готов",uk:"Ти не готовий",es:"Tú no estás listo",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"estás",type:"verb"},{text:" ",type:"space"},{text:"listo",type:"object"}],meta:{id:"estar_pres_tu_neg_listo",lemma:"estar",person:"tu",polarity:"negative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Ты здесь",uk:"Ти тут",es:"Tú estás aquí",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"estás",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_tu_aff_aqui",lemma:"estar",person:"tu",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Ты не здесь",uk:"Ти не тут",es:"Tú no estás aquí",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"estás",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_tu_neg_aqui",lemma:"estar",person:"tu",polarity:"negative",tense:"present",tags:["location"],confusable_with:"ser"}}
    ]
  },
  {
    id: "w1_l11b", 
    ...
    phrases: [
      ...
      {ru:"Она готова",uk:"Вона готова",es:"Ella está lista",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"lista",type:"object"}],meta:{id:"estar_pres_ella_aff_lista",lemma:"estar",person:"ella",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"С вами все в порядке (вежливо)",uk:"З вами все гаразд (ввічливо)",es:"Usted está bien",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_usted_aff_bien",lemma:"estar",person:"usted",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      ...
      {ru:"Вы не здесь (вежливо)",uk:"Ви не тут (ввічливо)",es:"Usted no está aquí",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_usted_neg_aqui",lemma:"estar",person:"usted",polarity:"negative",tense:"present",tags:["location"],confusable_with:"ser"}}
    ]
  },
  {
    id: "w1_l12", 
  ...
  },
  {
    ...
    title: "State & Location",
    phrases: [
      {ru:"Им (мужской род) хорошо",uk:"Їм (ч.р.) добре",es:"Ellos están bien",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_ellos_aff_bien",lemma:"estar",person:"ellos",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Им (женский род) плохо",uk:"Їм (ж.р.) погано",es:"Ellas están mal",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"mal",type:"object"}],meta:{id:"estar_pres_ellas_aff_mal",lemma:"estar",person:"ellas",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Вы здесь (вежливо)",uk:"Ви тут (ввічливо)",es:"Ustedes están aquí",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_ustedes_aff_aqui",lemma:"estar",person:"ustedes",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Они (м.р.) не здесь",uk:"Вони (ч.р.) не тут",es:"Ellos no están aquí",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_ellos_neg_aqui",lemma:"estar",person:"ellos",polarity:"negative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Они (ж.р.) не готовы",uk:"Вони (ж.р.) не готові",es:"Ellas no están listas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"listas",type:"object"}],meta:{id:"estar_pres_ellas_neg_listas",lemma:"estar",person:"ellas",polarity:"negative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Вы не готовы (вежливо)",uk:"Ви не готові (ввічливо)",es:"Ustedes no están listos",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"listos",type:"object"}],meta:{id:"estar_pres_ustedes_neg_listos",lemma:"estar",person:"ustedes",polarity:"negative",tense:"present",tags:["state"],confusable_with:"ser"}}
    ]
  },
  ...
  // --- Ir + Tener Sentences ---
  {
    ...
    phrases: [
      ...
      {ru:"У меня есть время",uk:"У мене є час",es:"Yo tengo tiempo",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"tengo",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_yo_aff_tiempo",lemma:"tener",person:"yo",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У меня нет времени",uk:"У мене немає часу",es:"Yo no tengo tiempo",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"tengo",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_yo_neg_tiempo",lemma:"tener",person:"yo",polarity:"negative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У меня есть деньги",uk:"У мене є гроші",es:"Yo tengo dinero",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"tengo",type:"verb"},{text:" ",type:"space"},{text:"dinero",type:"object"}],meta:{id:"tener_pres_yo_aff_dinero",lemma:"tener",person:"yo",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}}
    ]
  },
  {
    id: "w1_l14a", 
    ...
    phrases: [
      ...
      {ru:"Ты не идешь туда",uk:"Ти не йдеш туди",es:"Tú no vas allí",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"vas",type:"verb"},{text:" ",type:"space"},{text:"allí",type:"object"}],meta:{id:"ir_pres_tu_neg_alli",lemma:"ir",person:"tu",polarity:"negative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      ...
      {ru:"У тебя есть время",uk:"У тебе є час",es:"Tú tienes tiempo",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"tienes",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_tu_aff_tiempo",lemma:"tener",person:"tu",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У тебя нет времени",uk:"У тебе немає часу",es:"Tú no tienes tiempo",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"tienes",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_tu_neg_tiempo",lemma:"tener",person:"tu",polarity:"negative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У тебя есть деньги",uk:"Ти маєш гроші",es:"Tú tienes dinero",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"tienes",type:"verb"},{text:" ",type:"space"},{text:"dinero",type:"object"}],meta:{id:"tener_pres_tu_aff_dinero",lemma:"tener",person:"tu",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}}
    ]
  },
  {
    id: "w1_l14b", 
    ...
    title: "Possession & Direction",
    phrases: [
      {ru:"Он не идет туда",uk:"Він не іде туди",es:"Él no va allí",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"va",type:"verb"},{text:" ",type:"space"},{text:"allí",type:"object"}],meta:{id:"ir_pres_el_neg_alli",lemma:"ir",person:"el",polarity:"negative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      {ru:"Она не идет туда",uk:"Вона не іде туди",es:"Ella no va allí",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"va",type:"verb"},{text:" ",type:"space"},{text:"allí",type:"object"}],meta:{id:"ir_pres_ella_neg_alli",lemma:"ir",person:"ella",polarity:"negative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      {ru:"У вас есть время (вежливо)",uk:"У вас є час (ввічливо)",es:"Usted tiene tiempo",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_usted_aff_tiempo",lemma:"tener",person:"usted",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"Он идет домой",uk:"Він йде додому",es:"Él va a casa",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"va",type:"verb"},{text:" ",type:"space"},{text:"a casa",type:"object"}],meta:{id:"ir_pres_el_aff_casa",lemma:"ir",person:"el",polarity:"affirmative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      {ru:"Она идет домой",uk:"Вона йде додому",es:"Ella va a casa",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"va",type:"verb"},{text:" ",type:"space"},{text:"a casa",type:"object"}],meta:{id:"ir_pres_ella_aff_casa",lemma:"ir",person:"ella",polarity:"affirmative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      {ru:"Вы идете домой (вежливо)",uk:"Ви йдете додому (ввічливо)",es:"Usted va a casa",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"va",type:"verb"},{text:" ",type:"space"},{text:"a casa",type:"object"}],meta:{id:"ir_pres_usted_aff_casa",lemma:"ir",person:"usted",polarity:"affirmative",tense:"present",tags:["motion","direction"],confusable_with:null}}
    ]
  },
  {
    id: "w1_l15", 
  ...
  },
  {
    ...
    title: "Possession & Direction",
    phrases: [
      {ru:"Они (м.р.) идут туда",uk:"Вони (ч.р.) йдуть туди",es:"Ellos van allí",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"van",type:"verb"},{text:" ",type:"space"},{text:"allí",type:"object"}],meta:{id:"ir_pres_ellos_aff_alli",lemma:"ir",person:"ellos",polarity:"affirmative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      {ru:"Они (ж.р.) не идут туда",uk:"Вони (ж.р.) не йдуть туди",es:"Ellas no van allí",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"van",type:"verb"},{text:" ",type:"space"},{text:"allí",type:"object"}],meta:{id:"ir_pres_ellas_neg_alli",lemma:"ir",person:"ellas",polarity:"negative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      {ru:"Вы идете домой (вежливо)",uk:"Ви йдете додому (ввічливо)",es:"Ustedes van a casa",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"van",type:"verb"},{text:" ",type:"space"},{text:"a casa",type:"object"}],meta:{id:"ir_pres_ustedes_aff_casa",lemma:"ir",person:"ustedes",polarity:"affirmative",tense:"present",tags:["motion","direction"],confusable_with:null}},
      {ru:"Они (м.р.) не имеют времени",uk:"Вони (ч.р.) не мають часу",es:"Ellos no tienen tiempo",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"tienen",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_ellos_neg_tiempo",lemma:"tener",person:"ellos",polarity:"negative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"Они (ж.р.) имеют деньги",uk:"Вони (ж.р.) мають гроші",es:"Ellas tienen dinero",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"},{text:" ",type:"space"},{text:"dinero",type:"object"}],meta:{id:"tener_pres_ellas_aff_dinero",lemma:"tener",person:"ellas",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"Вы не имеете денег (вежливо)",uk:"Ви не маєте грошей (ввічливо)",es:"Ustedes no tienen dinero",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"tienen",type:"verb"},{text:" ",type:"space"},{text:"dinero",type:"object"}],meta:{id:"tener_pres_ustedes_neg_dinero",lemma:"tener",person:"ustedes",polarity:"negative",tense:"present",tags:["possession"],confusable_with:null}}
    ]
  },
