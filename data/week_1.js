...
const week1Lessons = [
  ...
  },
  {
    ...
    phrases: [
      {ru:"Они (м.р.) (есть)",es:"Ellos son",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"}],meta:{id:"ser_pres_ellos_aff",lemma:"ser",person:"ellos",polarity:"affirmative",tense:"present",tags:["identity"],confusable_with:"estar"}},
      {ru:"Они (ж.р.) (есть)",es:"Ellas son",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"}],meta:{id:"ser_pres_ellas_aff",lemma:"ser",person:"ellas",polarity:"affirmative",tense:"present",tags:["identity"],confusable_with:"estar"}},
      ...
      {ru:"Они (м.р.) находятся",es:"Ellos están",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"}],meta:{id:"estar_pres_ellos_aff",lemma:"estar",person:"ellos",polarity:"affirmative",tense:"present",tags:["state","location"],confusable_with:"ser"}},
      {ru:"Они (ж.р.) идут",es:"Ellas van",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"van",type:"verb"}],meta:{id:"ir_pres_ellas_aff",lemma:"ir",person:"ellas",polarity:"affirmative",tense:"present",tags:["motion"],confusable_with:null}},
  ...
  },
  {
    ...
    phrases: [
      {ru:"У них (м.р.) есть",es:"Ellos tienen",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"}],meta:{id:"tener_pres_ellos_aff",lemma:"tener",person:"ellos",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У них (ж.р.) есть",es:"Ellas tienen",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"}],meta:{id:"tener_pres_ellas_aff",lemma:"tener",person:"ellas",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      ...
      {ru:"Они (м.р.) делают",es:"Ellos hacen",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"hacen",type:"verb"}],meta:{id:"hacer_pres_ellos_aff",lemma:"hacer",person:"ellos",polarity:"affirmative",tense:"present",tags:["action"],confusable_with:null}},
      {ru:"Они (ж.р.) говорят",es:"Ellas dicen",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"dicen",type:"verb"}],meta:{id:"decir_pres_ellas_aff",lemma:"decir",person:"ellas",polarity:"affirmative",tense:"present",tags:["speech"],confusable_with:null}},
  ...
  },
  {
    ...
    phrases: [
      {ru:"Они (м.р.) хорошие",es:"Ellos son buenos",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"buenos",type:"object"}],meta:{id:"ser_pres_ellos_aff_buenos",lemma:"ser",person:"ellos",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Они (ж.р.) маленькие",es:"Ellas son pequeñas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"pequeñas",type:"object"}],meta:{id:"ser_pres_ellas_aff_pequenas",lemma:"ser",person:"ellas",polarity:"affirmative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
  ...
  },
  {
    ...
    phrases: [
      {ru:"Им (м.р.) хорошо",es:"Ellos están bien",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_ellos_aff_bien",lemma:"estar",person:"ellos",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Им (ж.р.) плохо",es:"Ellas están mal",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"mal",type:"object"}],meta:{id:"estar_pres_ellas_aff_mal",lemma:"estar",person:"ellas",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      ...
      {ru:"Они (м.р.) не здесь",es:"Ellos no están aquí",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_ellos_neg_aqui",lemma:"estar",person:"ellos",polarity:"negative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Они (ж.р.) готовы",es:"Ellas están listas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"listas",type:"object"}],meta:{id:"estar_pres_ellas_aff_listas",lemma:"estar",person:"ellas",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
