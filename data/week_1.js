const week1Lessons = [
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Ты здесь",es:"Tú estás aquí",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"estás",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_tu_aff_aqui",lemma:"estar",person:"tu",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Вы здесь",es:"Usted está aquí",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_usted_aff_aqui",lemma:"estar",person:"usted",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}}
    ]
  },
  {
