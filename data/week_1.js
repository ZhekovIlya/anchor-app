const week1Lessons = [
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Он идет",uk:"Він іде",es:"Él va",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"va",type:"verb"}],meta:{id:"ir_pres_el_aff",lemma:"ir",person:"el",polarity:"affirmative",tense:"present",tags:["motion"],confusable_with:null}},
      {ru:"Она идет",uk:"Вона іде",es:"Ella va",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"va",type:"verb"}],meta:{id:"ir_pres_ella_aff",lemma:"ir",person:"ella",polarity:"affirmative",tense:"present",tags:["motion"],confusable_with:null}}
    ]
  },
  {
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"У вас есть",uk:"У вас є",es:"Usted tiene",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"}],meta:{id:"tener_pres_usted_aff",lemma:"tener",person:"usted",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
  ...
  },
  {
    ...
    phrases: [
      {ru:"У них (мужской род) есть",uk:"У них (чоловічий рід) є",es:"Ellos tienen",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"}],meta:{id:"tener_pres_ellos_aff",lemma:"tener",person:"ellos",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У них (женский род) есть",uk:"У них (жіночий рід) є",es:"Ellas tienen",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"}],meta:{id:"tener_pres_ellas_aff",lemma:"tener",person:"ellas",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Он не глупый",uk:"Он не глупый",es:"Él no es tonto",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"es",type:"verb"},{text:" ",type:"space"},{text:"tonto",type:"object"}],meta:{id:"ser_pres_el_neg_tonto",lemma:"ser",person:"el",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      {ru:"Она не глупая",uk:"Она не глупая",es:"Ella no es tonta",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"es",type:"verb"},{text:" ",type:"space"},{text:"tonta",type:"object"}],meta:{id:"ser_pres_ella_neg_tonta",lemma:"ser",person:"ella",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}}
    ]
  },
  {
    ...
    phrases: [
      ...
      {ru:"Мы не маленькие",uk:"Мы не маленькие",es:"Nosotros no somos pequeños",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"somos",type:"verb"},{text:" ",type:"space"},{text:"pequeños",type:"object"}],meta:{id:"ser_pres_nos_neg_pequenos",lemma:"ser",person:"nosotros",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}},
      ...
      {ru:"Мы не глупые",uk:"Мы не глупые",es:"Nosotros no somos tontos",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"somos",type:"verb"},{text:" ",type:"space"},{text:"tontos",type:"object"}],meta:{id:"ser_pres_nos_neg_tontos",lemma:"ser",person:"nosotros",polarity:"negative",tense:"present",tags:["identity","adjective"],confusable_with:"estar"}}
    ]
  },
  {
  ...
  // --- Estar Sentences ---
  {
    ...
    phrases: [
      {ru:"Мне хорошо",uk:"Мне хорошо",es:"Yo estoy bien",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"estoy",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_yo_aff_bien",lemma:"estar",person:"yo",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Мне плохо",uk:"Мне плохо",es:"Yo estoy mal",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"estoy",type:"verb"},{text:" ",type:"space"},{text:"mal",type:"object"}],meta:{id:"estar_pres_yo_aff_mal",lemma:"estar",person:"yo",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      ...
      {ru:"Я не готов",uk:"Я не готов",es:"Yo no estoy listo",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"estoy",type:"verb"},{text:" ",type:"space"},{text:"listo",type:"object"}],meta:{id:"estar_pres_yo_neg_listo",lemma:"estar",person:"yo",polarity:"negative",tense:"present",tags:["state"],confusable_with:"ser"}}
    ]
  },
  {
    id: "w1_l11a", title: "4A. Estar Sentences — Tú / Usted",
    phrases: [
      {ru:"Тебе хорошо",uk:"Тебе хорошо",es:"Tú estás bien",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"estás",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_tu_aff_bien",lemma:"estar",person:"tu",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Вам хорошо",uk:"Вам хорошо",es:"Usted está bien",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_usted_aff_bien",lemma:"estar",person:"usted",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Ты готов",uk:"Ты готов",es:"Tú estás listo",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"estás",type:"verb"},{text:" ",type:"space"},{text:"listo",type:"object"}],meta:{id:"estar_pres_tu_aff_listo",lemma:"estar",person:"tu",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Вы готовы",uk:"Вы готовы",es:"Usted está listo",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"listo",type:"object"}],meta:{id:"estar_pres_usted_aff_listo",lemma:"estar",person:"usted",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      ...
      {ru:"Вы здесь",uk:"Вы здесь",es:"Usted está aquí",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_usted_aff_aqui",lemma:"estar",person:"usted",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}}
    ]
  },
  {
    ...
    phrases: [
      ...
      {ru:"Она здесь",uk:"Она здесь",es:"Ella está aquí",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_ella_aff_aqui",lemma:"estar",person:"ella",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}},
      ...
      {ru:"Она не готова",uk:"Она не готова",es:"Ella no está lista",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"está",type:"verb"},{text:" ",type:"space"},{text:"lista",type:"object"}],meta:{id:"estar_pres_ella_neg_lista",lemma:"estar",person:"ella",polarity:"negative",tense:"present",tags:["state"],confusable_with:"ser"}}
    ]
  },
  {
    id: "w1_l12", title: "4C. Estar Sentences — Nosotros (We)",
    phrases: [
      {ru:"Нам хорошо",uk:"Нам хорошо",es:"Nosotros estamos bien",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"estamos",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_nos_aff_bien",lemma:"estar",person:"nosotros",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Нам плохо",uk:"Нам плохо",es:"Nosotros estamos mal",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"estamos",type:"verb"},{text:" ",type:"space"},{text:"mal",type:"object"}],meta:{id:"estar_pres_nos_aff_mal",lemma:"estar",person:"nosotros",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
  ...
  },
  {
    ...
    phrases: [
      {ru:"Им (мужской род) хорошо",uk:"Им (мужской род) хорошо",es:"Ellos están bien",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"bien",type:"object"}],meta:{id:"estar_pres_ellos_aff_bien",lemma:"estar",person:"ellos",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Им (женский род) плохо",uk:"Им (женский род) плохо",es:"Ellas están mal",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"mal",type:"object"}],meta:{id:"estar_pres_ellas_aff_mal",lemma:"estar",person:"ellas",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Вы здесь",uk:"Вы здесь",es:"Ustedes están aquí",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_ustedes_aff_aqui",lemma:"estar",person:"ustedes",polarity:"affirmative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Они (мужской род) не здесь",uk:"Они (мужской род) не здесь",es:"Ellos no están aquí",tokens:[{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"aquí",type:"object"}],meta:{id:"estar_pres_ellos_neg_aqui",lemma:"estar",person:"ellos",polarity:"negative",tense:"present",tags:["location"],confusable_with:"ser"}},
      {ru:"Они (женский род) готовы",uk:"Они (женский род) готовы",es:"Ellas están listas",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"listas",type:"object"}],meta:{id:"estar_pres_ellas_aff_listas",lemma:"estar",person:"ellas",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Вы не готовы",uk:"Вы не готовы",es:"Ustedes no están listos",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"listos",type:"object"}],meta:{id:"estar_pres_ustedes_neg_listos",lemma:"estar",person:"ustedes",polarity:"negative",tense:"present",tags:["state"],confusable_with:"ser"}}
    ]
  },
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Ты идешь домой",uk:"Ты идешь домой",es:"Tú vas a casa",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"vas",type:"verb"},{text:" ",type:"space"},{text:"a casa",type:"object"}],meta:{id:"ir_pres_tu_aff_casa",lemma:"ir",person:"tu",polarity:"affirmative",tense:"present",tags:["motion","direction"],confusable_with:null}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"У него есть время",uk:"У нього є час",es:"Él tiene tiempo",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_el_aff_tiempo",lemma:"tener",person:"el",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У нее есть время",uk:"У неї є час",es:"Ella tiene tiempo",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"tener_pres_ella_aff_tiempo",lemma:"tener",person:"ella",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У него есть деньги",uk:"У нього є гроші",es:"Él tiene dinero",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"dinero",type:"object"}],meta:{id:"tener_pres_el_aff_dinero",lemma:"tener",person:"el",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У нее есть деньги",uk:"У неї є гроші",es:"Ella tiene dinero",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"dinero",type:"object"}],meta:{id:"tener_pres_ella_aff_dinero",lemma:"tener",person:"ella",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}}
    ]
  },
  {
