const week2Lessons = [
  ...
  // ========================================================
  {
    ...
    phrases: [
      ...
      {ru:"Я готов",uk:"Я готовий",es:"Yo estoy listo",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"estoy",type:"verb"},{text:" ",type:"space"},{text:"listo",type:"object"}],meta:{id:"w2_estar_yo_listo_aff",lemma:"estar",person:"yo",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Я готов?",uk:"Я готовий?",es:"¿Yo estoy listo?",tokens:[{text:"¿",type:"space"},{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"estoy",type:"verb"},{text:" ",type:"space"},{text:"listo?",type:"object"}],meta:{id:"w2_estar_yo_listo_int",lemma:"estar",person:"yo",polarity:"interrogative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Я хочу арендовать",uk:"Я хочу орендувати",es:"Yo quiero alquilar",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"quiero",type:"verb"},{text:" ",type:"space"},{text:"alquilar",type:"verb_infinitive"}],meta:{id:"w2_querer_yo_alquilar_aff",lemma:"querer",person:"yo",polarity:"affirmative",tense:"present",tags:["intention","real_estate"],confusable_with:null}},
      {ru:"Я не хочу арендовать",uk:"Я не хочу орендувати",es:"Yo no quiero alquilar",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"quiero",type:"verb"},{text:" ",type:"space"},{text:"alquilar",type:"verb_infinitive"}],meta:{id:"w2_querer_yo_alquilar_neg",lemma:"querer",person:"yo",polarity:"negative",tense:"present",tags:["intention","real_estate"],confusable_with:null}}
    ]
  },
  {
    id: "w2_l2", 
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Мы хотим арендовать?",uk:"Ми хочемо орендувати?",es:"¿Nosotros queremos alquilar?",tokens:[{text:"¿",type:"space"},{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"queremos",type:"verb"},{text:" ",type:"space"},{text:"alquilar?",type:"verb_infinitive"}],meta:{id:"w2_querer_nos_alquilar_int",lemma:"querer",person:"nosotros",polarity:"interrogative",tense:"present",tags:["intention","real_estate"],confusable_with:null}},
      {ru:"Мы готовы",uk:"Ми готові",es:"Nosotros estamos listos",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"estamos",type:"verb"},{text:" ",type:"space"},{text:"listos",type:"object"}],meta:{id:"w2_estar_nos_listos_aff",lemma:"estar",person:"nosotros",polarity:"affirmative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Мы хорошие?",uk:"Ми добрі?",es:"¿Nosotros somos buenos?",tokens:[{text:"¿",type:"space"},{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"somos",type:"verb"},{text:" ",type:"space"},{text:"buenos?",type:"object"}],meta:{id:"w2_ser_nos_buenos_int",lemma:"ser",person:"nosotros",polarity:"interrogative",tense:"present",tags:["identity"],confusable_with:"estar"}},
      {ru:"Мы хотим арендовать",uk:"Ми хочемо орендувати",es:"Nosotros queremos alquilar",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"queremos",type:"verb"},{text:" ",type:"space"},{text:"alquilar",type:"verb_infinitive"}],meta:{id:"w2_querer_nos_alquilar_aff",lemma:"querer",person:"nosotros",polarity:"affirmative",tense:"present",tags:["intention"],confusable_with:null}}
    ]
  },
  {
    id: "w2_l5", 
    ...
    phrases: [
      ...
      {ru:"Вы (мн.ч.) хотите квартиру?",uk:"Ви (мн.) хочете квартиру?",es:"¿Ustedes quieren el piso?",tokens:[{text:"¿",type:"space"},{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"quieren",type:"verb"},{text:" ",type:"space"},{text:"el piso?",type:"object"}],meta:{id:"w2_querer_ustedes_piso_int",lemma:"querer",person:"ustedes",polarity:"interrogative",tense:"present",tags:["intention","real_estate"],confusable_with:null}},
      {ru:"Они (м.р.) готовы?",uk:"Вони (ч.р.) готові?",es:"¿Ellos están listos?",tokens:[{text:"¿",type:"space"},{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"están",type:"verb"},{text:" ",type:"space"},{text:"listos?",type:"object"}],meta:{id:"w2_estar_ellos_listos_int",lemma:"estar",person:"ellos",polarity:"interrogative",tense:"present",tags:["state"],confusable_with:"ser"}},
      {ru:"Они (ж.р.) большие",uk:"Вони (ж.р.) великі",es:"Ellas son grandes",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"son",type:"verb"},{text:" ",type:"space"},{text:"grandes",type:"object"}],meta:{id:"w2_ser_ellas_grandes_aff",lemma:"ser",person:"ellas",polarity:"affirmative",tense:"present",tags:["identity"],confusable_with:"estar"}},
      {ru:"Вы (мн.ч.) хотите арендовать",uk:"Ви (мн.) хочете орендувати",es:"Ustedes quieren alquilar",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"quieren",type:"verb"},{text:" ",type:"space"},{text:"alquilar",type:"verb_infinitive"}],meta:{id:"w2_querer_ustedes_alquilar_aff",lemma:"querer",person:"ustedes",polarity:"affirmative",tense:"present",tags:["intention"],confusable_with:null}}
    ]
  },
  ...
  // ========================================================
  {
    ...
    phrases: [
      ...
      {ru:"У меня есть деньги",uk:"У мене є гроші",es:"Yo tengo el dinero",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"tengo",type:"verb"},{text:" ",type:"space"},{text:"el dinero",type:"object"}],meta:{id:"w2_tener_yo_dinero_aff",lemma:"tener",person:"yo",polarity:"affirmative",tense:"present",tags:["possession"],confusable_with:null}},
      {ru:"У меня есть стиральная машина?",uk:"У мене є пральна машина?",es:"¿Yo tengo la lavadora?",tokens:[{text:"¿",type:"space"},{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"tengo",type:"verb"},{text:" ",type:"space"},{text:"la lavadora?",type:"object"}],meta:{id:"w2_tener_yo_lavadora_int",lemma:"tener",person:"yo",polarity:"interrogative",tense:"present",tags:["possession","appliances"],confusable_with:null}},
      {ru:"У меня нет холодильника",uk:"У мене немає холодильника",es:"Yo no tengo nevera",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"tengo",type:"verb"},{text:" ",type:"space"},{text:"nevera",type:"object"}],meta:{id:"w2_tener_yo_nevera_neg",lemma:"tener",person:"yo",polarity:"negative",tense:"present",tags:["possession","appliances"],confusable_with:null}},
      {ru:"Я могу пойти туда?",uk:"Я можу піти туди?",es:"¿Yo puedo ir allí?",tokens:[{text:"¿",type:"space"},{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"puedo",type:"verb"},{text:" ",type:"space"},{text:"ir allí?",type:"object"}],meta:{id:"w2_poder_yo_ir_int",lemma:"poder",person:"yo",polarity:"interrogative",tense:"present",tags:["ability","motion"],confusable_with:null}}
    ]
  },
  {
    id: "w2_l7", 
  ...
  // ========================================================
  {
    ...
    phrases: [
      ...
      {ru:"Мне нужно помочь",uk:"Мені потрібно допомогти",es:"Yo necesito ayudar",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"necesito",type:"verb"},{text:" ",type:"space"},{text:"ayudar",type:"verb_infinitive"}],meta:{id:"w2_necesitar_yo_ayudar_aff",lemma:"necesitar",person:"yo",polarity:"affirmative",tense:"present",tags:["need"],confusable_with:null}},
      {ru:"Я могу сделать",uk:"Я можу зробити",es:"Yo puedo hacer",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"puedo",type:"verb"},{text:" ",type:"space"},{text:"hacer",type:"verb_infinitive"}],meta:{id:"w2_poder_yo_hacer_aff",lemma:"poder",person:"yo",polarity:"affirmative",tense:"present",tags:["ability"],confusable_with:null}},
      {ru:"Я не говорю",uk:"Я не кажу",es:"Yo no digo",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"digo",type:"verb"}],meta:{id:"w2_decir_yo_neg",lemma:"decir",person:"yo",polarity:"negative",tense:"present",tags:["speech"],confusable_with:null}},
      {ru:"Мне нужно время",uk:"Мені потрібен час",es:"Yo necesito tiempo",tokens:[{text:"Yo",type:"subject"},{text:" ",type:"space"},{text:"necesito",type:"verb"},{text:" ",type:"space"},{text:"tiempo",type:"object"}],meta:{id:"w2_necesitar_yo_tiempo_aff",lemma:"necesitar",person:"yo",polarity:"affirmative",tense:"present",tags:["need"],confusable_with:null}}
    ]
  },
  {
    id: "w2_l12", 
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Нам нужно помочь",uk:"Нам потрібно допомогти",es:"Nosotros necesitamos ayudar",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"necesitamos",type:"verb"},{text:" ",type:"space"},{text:"ayudar",type:"verb_infinitive"}],meta:{id:"w2_necesitar_nos_ayudar_aff",lemma:"necesitar",person:"nosotros",polarity:"affirmative",tense:"present",tags:["need"],confusable_with:null}},
      {ru:"Мы можем сделать",uk:"Ми можемо зробити",es:"Nosotros podemos hacer",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"podemos",type:"verb"},{text:" ",type:"space"},{text:"hacer",type:"verb_infinitive"}],meta:{id:"w2_poder_nos_hacer_aff",lemma:"poder",person:"nosotros",polarity:"affirmative",tense:"present",tags:["ability"],confusable_with:null}},
      {ru:"Мы не говорим",uk:"Ми не кажемо",es:"Nosotros no decimos",tokens:[{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"decimos",type:"verb"}],meta:{id:"w2_decir_nos_neg",lemma:"decir",person:"nosotros",polarity:"negative",tense:"present",tags:["speech"],confusable_with:null}},
      {ru:"Нам нужны деньги?",uk:"Нам потрібні гроші?",es:"¿Nosotros necesitamos dinero?",tokens:[{text:"¿",type:"space"},{text:"Nosotros",type:"subject"},{text:" ",type:"space"},{text:"necesitamos",type:"verb"},{text:" ",type:"space"},{text:"dinero?",type:"object"}],meta:{id:"w2_necesitar_nos_dinero_int",lemma:"necesitar",person:"nosotros",polarity:"interrogative",tense:"present",tags:["need","finance"],confusable_with:null}}
    ]
  },
  {
    id: "w2_l15", 
    ...
    phrases: [
      ...
      {ru:"Вам (мн.ч.) нужно помочь",uk:"Вам (мн.) потрібно допомогти",es:"Ustedes necesitan ayudar",tokens:[{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"necesitan",type:"verb"},{text:" ",type:"space"},{text:"ayudar",type:"verb_infinitive"}],meta:{id:"w2_necesitar_ustedes_ayudar_aff",lemma:"necesitar",person:"ustedes",polarity:"affirmative",tense:"present",tags:["need"],confusable_with:null}},
      {ru:"Они (м.р.) могут сделать?",uk:"Вони (ч.р.) можуть зробити?",es:"¿Ellos pueden hacer?",tokens:[{text:"¿",type:"space"},{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"pueden",type:"verb"},{text:" ",type:"space"},{text:"hacer?",type:"verb_infinitive"}],meta:{id:"w2_poder_ellos_hacer_int",lemma:"poder",person:"ellos",polarity:"interrogative",tense:"present",tags:["ability"],confusable_with:null}},
      {ru:"Они (ж.р.) не говорят",uk:"Вони (ж.р.) не кажуть",es:"Ellas no dicen",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"dicen",type:"verb"}],meta:{id:"w2_decir_ellas_neg",lemma:"decir",person:"ellas",polarity:"negative",tense:"present",tags:["speech"],confusable_with:null}},
      {ru:"Вам (мн.ч.) нужно время?",uk:"Вам (мн.) потрібен час?",es:"¿Ustedes necesitan tiempo?",tokens:[{text:"¿",type:"space"},{text:"Ustedes",type:"subject"},{text:" ",type:"space"},{text:"necesitan",type:"verb"},{text:" ",type:"space"},{text:"tiempo?",type:"object"}],meta:{id:"w2_necesitar_ustedes_tiempo_int",lemma:"necesitar",person:"ustedes",polarity:"interrogative",tense:"present",tags:["need"],confusable_with:null}}
    ]
  },
