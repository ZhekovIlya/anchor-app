const week5Lessons = [
  ...
  },
  {
    id: "w5_l14",
    tab: "past_erir",
    title: "Past -ER/-IR Mix",
    phrases: [
      { ru: "Я ел и пил вчера", uk: "Я їв і пив вчора", es: "Yo comí y bebí ayer" },
  ...
  },
  {
    id: "w5_exam_erir",
    tab: "past_erir",
    title: "📝 Past -ER/-IR Quiz",
    exam: true,
  },

  // ═══════════════════════════════════════════════════════
  // TAB 3: PASADO — REPASO (Old verbs in past tense)
  // W4 verbs (lavar, secar, limpiar, abrir, cerrar, usar)
  // W3 verbs (ladrar, morder) + W2 (necesitar)
  // All conjugated in Pretérito: Yo (-é/-í) + Él/Ella (-ó/-ió)
  // ═══════════════════════════════════════════════════════
  {
    id: "w5_l15",
    tab: "review",
    title: "Past Review: Washing",
    phrases: [
      { ru: "Я помыл грязные лапы мылом", uk: "Я помив брудні лапи милом", es: "Yo lavé las patas sucias con el jabón" },
      { ru: "Он высушил собаку полотенцем", uk: "Він висушив собаку рушником", es: "Él secó el perro con la toalla" },
      { ru: "Она помыла собаку вчера", uk: "Вона помила собаку вчора", es: "Ella lavó el perro ayer" },
      { ru: "Я не помыл лапы вчера", uk: "Я не помив лапи вчора", es: "Yo no lavé las patas ayer" },
      { ru: "Он высушил лапы полотенцем", uk: "Він висушив лапи рушником", es: "Él secó las patas con la toalla" },
      { ru: "Она не высушила собаку", uk: "Вона не висушила собаку", es: "Ella no secó el perro" },
    ],
  },
  {
    id: "w5_l16",
    tab: "review",
    title: "Past Review: Cleaning",
    phrases: [
      { ru: "Я убрал кухню и ванную", uk: "Я прибрав кухню і ванну", es: "Yo limpié la cocina y el baño" },
      { ru: "Она убрала комнату вчера", uk: "Вона прибрала кімнату вчора", es: "Ella limpió la habitación ayer" },
      { ru: "Он убрал дом и сад", uk: "Він прибрав будинок і сад", es: "Él limpió la casa y el jardín" },
      { ru: "Я не убрал сад вчера", uk: "Я не прибрав сад вчора", es: "Yo no limpié el jardín ayer" },
      { ru: "Она помыла кухню водой", uk: "Вона помила кухню водою", es: "Ella lavó la cocina con el agua" },
      { ru: "Он убрал ванную и кухню", uk: "Він прибрав ванну і кухню", es: "Él limpió el baño y la cocina" },
    ],
  },
  {
    id: "w5_l17",
    tab: "review",
    title: "Past Review: Tools",
    phrases: [
      { ru: "Я использовал ключ для двери", uk: "Я використав ключ для дверей", es: "Yo usé la llave para la puerta" },
      { ru: "Она закрыла окно и дверь", uk: "Вона закрила вікно і двері", es: "Ella cerró la ventana y la puerta" },
      { ru: "Он открыл дверь в сад", uk: "Він відкрив двері в сад", es: "Él abrió la puerta del jardín" },
      { ru: "Я не открыл окно вчера", uk: "Я не відкрив вікно вчора", es: "Yo no abrí la ventana ayer" },
      { ru: "Она использовала душ вчера", uk: "Вона використала душ вчора", es: "Ella usó la ducha ayer" },
      { ru: "Он закрыл дверь", uk: "Він закрив двері", es: "Él cerró la puerta" },
    ],
  },
  {
    id: "w5_l18",
    tab: "review",
    title: "Past Review: Finance",
    phrases: [
      { ru: "Я заплатил за аренду вчера", uk: "Я заплатив за оренду вчора", es: "Yo pagué el alquiler ayer" },
      { ru: "Он заплатил за контракт", uk: "Він заплатив за контракт", es: "Él pagó el contrato" },
      { ru: "Она заплатила за дом", uk: "Вона заплатила за будинок", es: "Ella pagó la casa" },
      { ru: "Я не заплатил за аренду", uk: "Я не заплатив за оренду", es: "Yo no pagué el alquiler" },
      { ru: "Он заплатил за дорогую аренду", uk: "Він заплатив за дорогу оренду", es: "Él pagó el alquiler caro" },
      { ru: "Она убрала дом для контракта", uk: "Вона прибрала будинок для контракту", es: "Ella limpió la casa para el contrato" },
    ],
  },
  {
    id: "w5_l19",
    tab: "review",
    title: "Past Review: Dog Park",
    phrases: [
      { ru: "Он лаял в парке вчера", uk: "Він гавкав у парку вчора", es: "Él ladró en el parque ayer" },
      { ru: "Она не кусала", uk: "Вона не кусала", es: "Ella no mordió" },
      { ru: "Я помыл собаку после парка", uk: "Я помив собаку після парку", es: "Yo lavé el perro del parque" },
      { ru: "Он лаял и кусал вчера", uk: "Він гавкав і кусав вчора", es: "Él ladró y mordió ayer" },
      { ru: "Она не лаяла в парке", uk: "Вона не гавкала в парку", es: "Ella no ladró en el parque" },
      { ru: "Я высушил лапы после парка", uk: "Я висушив лапи після парку", es: "Yo sequé las patas del parque" },
    ],
  },
  {
    id: "w5_l20",
    tab: "review",
    title: "Past Review: Needs",
    phrases: [
      { ru: "Мне нужен был контракт", uk: "Мені потрібен був контракт", es: "Yo necesité el contrato" },
      { ru: "Она открыла дверь ключом", uk: "Вона відкрила двері ключем", es: "Ella abrió la puerta con la llave" },
      { ru: "Он использовал воду и мыло", uk: "Він використав воду і мило", es: "Él usó el agua y el jabón" },
      { ru: "Я закрыл окно вчера", uk: "Я закрив вікно вчора", es: "Yo cerré la ventana ayer" },
      { ru: "Она убрала кухню и закрыла дверь", uk: "Вона прибрала кухню і закрила двері", es: "Ella limpió la cocina y cerró la puerta" },
      { ru: "Он помыл лапы и высушил собаку", uk: "Він помив лапи і висушив собаку", es: "Él lavó las patas y secó el perro" },
    ],
  },
  {
    id: "w5_exam_review",
...
export default {
  id: "week_5",
  title: "Week 5: The Past Switch",
  legacy: false,
  tabs: [
    { id: "past_ar", label: "Pasado: -AR" },
    { id: "past_erir", label: "Pasado: -ER/-IR" },
    { id: "review", label: "Pasado: Repaso" },
  ],
