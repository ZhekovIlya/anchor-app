const week3Lessons = [
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"У тебя есть поводок",uk:"У тебе є повідок",es:"Tú tienes la correa",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"tienes",type:"verb"},{text:" ",type:"space"},{text:"la correa",type:"object"}],meta:{id:"w3_tener_tu_correa_aff",lemma:"tener",person:"tu",polarity:"affirmative",tense:"present",tags:["possession","dog"]}},
      ...
      {ru:"Ты хочешь пойти?",uk:"Ти хочеш піти?",es:"¿Tú quieres ir?",tokens:[{text:"¿",type:"space"},{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"quieres",type:"verb"},{text:" ",type:"space"},{text:"ir?",type:"verb_infinitive"}],meta:{id:"w3_querer_tu_ir_int",lemma:"querer",person:"tu",polarity:"interrogative",tense:"present",tags:["intention","motion"]}},
  ...
  },
  {
    ...
    title: "At the Dog Park",
    phrases: [
      {ru:"У него есть собака",uk:"Він має собаку",es:"Él tiene el perro",tokens:[{text:"Él",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"el perro",type:"object"}],meta:{id:"w3_tener_el_perro_aff",lemma:"tener",person:"el",polarity:"affirmative",tense:"present",tags:["possession","dog"]}},
      {ru:"У нее есть поводок",uk:"Вона має повідок",es:"Ella tiene la correa",tokens:[{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"la correa",type:"object"}],meta:{id:"w3_tener_ella_correa_aff",lemma:"tener",person:"ella",polarity:"affirmative",tense:"present",tags:["possession","dog"]}},
      {ru:"У вас (вежливо) есть поводок",uk:"Ви маєте повідок (ввічливо)",es:"Usted tiene la correa",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"tiene",type:"verb"},{text:" ",type:"space"},{text:"la correa",type:"object"}],meta:{id:"w3_tener_usted_correa_aff",lemma:"tener",person:"usted",polarity:"affirmative",tense:"present",tags:["possession","dog"]}},
      ...
      {ru:"Ей нужен поводок?",uk:"Їй потрібен повідок?",es:"¿Ella necesita la correa?",tokens:[{text:"¿",type:"space"},{text:"Ella",type:"subject"},{text:" ",type:"space"},{text:"necesita",type:"verb"},{text:" ",type:"space"},{text:"la correa?",type:"object"}],meta:{id:"w3_necesitar_ella_correa_int",lemma:"necesitar",person:"ella",polarity:"interrogative",tense:"present",tags:["need","dog"]}},
      {ru:"Вы (вежливо) хотите пойти?",uk:"Ви хочете піти (ввічливо)?",es:"¿Usted quiere ir?",tokens:[{text:"¿",type:"space"},{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"quiere",type:"verb"},{text:" ",type:"space"},{text:"ir?",type:"verb_infinitive"}],meta:{id:"w3_querer_usted_ir_parque_int",lemma:"querer",person:"usted",polarity:"interrogative",tense:"present",tags:["intention","motion"]}}
    ]
  },
  {
    id: "w3_l4", 
  ...
  },
  {
    ...
    title: "At the Dog Park",
    phrases: [
      {ru:"Они (м.р.) имеют собаку?",uk:"Вони (ч.р.) мають собаку?",es:"¿Ellos tienen el perro?",tokens:[{text:"¿",type:"space"},{text:"Ellos",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"},{text:" ",type:"space"},{text:"el perro?",type:"object"}],meta:{id:"w3_tener_ellos_perro_int",lemma:"tener",person:"ellos",polarity:"interrogative",tense:"present",tags:["possession","dog"]}},
      {ru:"Они (ж.р.) имеют поводок",uk:"Вони (ж.р.) мають повідок",es:"Ellas tienen la correa",tokens:[{text:"Ellas",type:"subject"},{text:" ",type:"space"},{text:"tienen",type:"verb"},{text:" ",type:"space"},{text:"la correa",type:"object"}],meta:{id:"w3_tener_ellas_correa_aff",lemma:"tener",person:"ellas",polarity:"affirmative",tense:"present",tags:["possession","dog"]}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Ты не лаешь",uk:"Ти не гавкаєш",es:"Tú no ladras",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"ladras",type:"verb"}],meta:{id:"w3_ladrar_tu_neg",lemma:"ladrar",person:"tu",polarity:"negative",tense:"present",tags:["action","dog"]}},
      ...
      {ru:"Ты шумный",uk:"Ти гучний",es:"Tú eres ruidoso",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"eres",type:"verb"},{text:" ",type:"space"},{text:"ruidoso",type:"object"}],meta:{id:"w3_ser_tu_ruidoso_aff",lemma:"ser",person:"tu",polarity:"affirmative",tense:"present",tags:["identity","dog"]}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Вы (вежливо) не лаете",uk:"Ви не гавкаєте (ввічливо)",es:"Usted no ladra",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"ladra",type:"verb"}],meta:{id:"w3_ladrar_usted_neg",lemma:"ladrar",person:"usted",polarity:"negative",tense:"present",tags:["action","dog"]}},
      {ru:"Вы (вежливо) шумный",uk:"Ви гучний (ввічливо)",es:"Usted es ruidoso",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"es",type:"verb"},{text:" ",type:"space"},{text:"ruidoso",type:"object"}],meta:{id:"w3_ser_usted_ruidoso_aff",lemma:"ser",person:"usted",polarity:"affirmative",tense:"present",tags:["identity","dog"]}},
  ...
  },
  {
    ...
    phrases: [
      ...
      {ru:"Ты не кусаешь",uk:"Ти не кусаєш",es:"Tú no muerdes",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"muerdes",type:"verb"}],meta:{id:"w3_morder_tu_neg",lemma:"morder",person:"tu",polarity:"negative",tense:"present",tags:["action","dog"]}},
      ...
      {ru:"Ты не можешь кусать",uk:"Ти не можеш кусати",es:"Tú no puedes morder",tokens:[{text:"Tú",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"puedes",type:"verb"},{text:" ",type:"space"},{text:"morder",type:"verb_infinitive"}],meta:{id:"w3_poder_tu_morder_neg",lemma:"poder",person:"tu",polarity:"negative",tense:"present",tags:["ability"]}}
    ]
  },
  {
    id: "w3_l13", 
    ...
    phrases: [
      ...
      {ru:"Вы (вежливо) не кусаете",uk:"Ви не кусаєте (ввічливо)",es:"Usted no muerde",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"no",type:"negation"},{text:" ",type:"space"},{text:"muerde",type:"verb"}],meta:{id:"w3_morder_usted_neg",lemma:"morder",person:"usted",polarity:"negative",tense:"present",tags:["action","dog"]}},
      ...
      {ru:"Вы (вежливо) дружелюбный",uk:"Ви дружній (ввічливо)",es:"Usted es amistoso",tokens:[{text:"Usted",type:"subject"},{text:" ",type:"space"},{text:"es",type:"verb"},{text:" ",type:"space"},{text:"amistoso",type:"object"}],meta:{id:"w3_ser_usted_amistoso_aff",lemma:"ser",person:"usted",polarity:"affirmative",tense:"present",tags:["identity","dog"]}},
